...
public interface blogService {
    ...
    int saveArticle (@Param("article_name")String article_name,@Param("article_text")String article_text,@Param("summary")String summary,@Param("user_id") String user_id,@Param("blog_id") String blog_id);
    ...
    List<blogEntity> findArticleMsg (@Param("blog_id")String blog_id,@Param("pageIndex") int pageIndex);    List<blogEntity> getArticle (@Param("blog_id") String blog_id);
